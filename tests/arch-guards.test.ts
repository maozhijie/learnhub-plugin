...
test('G2 宿主模块可加载且装配面齐备', async () => {
  ...
  assert.equal(commands.COMMAND_LIST.length, 155, '注册表应为 155 条命令（#203 +1：receipt-review-mode；#215 +1：smoke；#216 +1：spike；#222 +1：quality-review；#240 +3：course-create、endpoint-add、endpoint-remove；#248 +1：stuck-report；#255 −1：doctor 并入 data-check；#256 −7：seed-propose、proposals-impact、project-decompile-apply、node-pin、review、courses、day-cutoff 死入口退役）')
  assert.equal(Object.keys(commands.COMMANDS).length, 155, '按 id 键的装配表应为 155 个键（#159 +1、#203 +1、#215 +1、#216 +1、#222 +1、#240 +3、#248 +1、#255 −1、#256 −7）')
  assert.equal(commands.BY_TOOL.size, 111, 'agent 通道索引应为 111 条工具（#203 +1；#256 −1：project-decompile-apply）')
