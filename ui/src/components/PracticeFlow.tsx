...
import { api } from '../api'
import { MAX_ASK_PER_ROUND, passStreakFor, QUIZ_SOFT_CAP } from '../lib/quiz-rules'
import { buildRounds, type Step } from '../lib/rounds'
...
export default function PracticeFlow(props: {
  ...
  useEffect(() => {
    ...
    // 只随题目集引用变化触发；其余状态经 gotoRound/setState 就地更新
