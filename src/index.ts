...
export function apply(ctx: Context, config?: LearnhubConfig) {
  ...
  tool('learnhub_probation',
    ...
    { type: 'object', properties: { action: { type: 'string', enum: ['status', 'settle'], description: 'default status' }, course: { type: 'string', description: 'course name; default all enabled courses' } } },
