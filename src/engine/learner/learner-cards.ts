...
import type { QuestionBank, BankDoc } from '../content/question-bank.ts'
import type { Projects } from '../practice/projects.ts'
import type { Habits, HabitDoc, HabitRepeatRec, ExecutionIntention } from '../practice/habits.ts'
import { automationCurve, habitStreak } from '../practice/habits.ts'
import type { Skills, SkillDoc, ExecutionEvidence, ExecutionLogResult, ExecutionSource } from '../practice/skills.ts'
import { clampMaintenanceDays, executionRowIdentity, executionXpDetail, laneDue, laneEventKind, ratingFromEvidence } from '../practice/skills.ts'
import type { NoteSourceManifest } from '../vault/note-source.ts'
import type { Graph } from '../graph/graph.ts'
import type { BrokenNote } from '../vault/notes.ts'
import { loadNote } from '../vault/notes.ts'
import type { FSRS } from 'ts-fsrs'
import { todayStr, dayOfTs, nowIsoOf } from '../infra/dates.ts'
import type { Clock } from '../infra/clock.ts'
import { nodeKeyOf } from '../types.ts'
import { round2 } from '../infra/grading.ts'
import { atomicWrite, readLearnhubConfig, writeLearnhubConfig } from '../infra/io.ts'
import type { BandPref } from '../sched/adaptive.ts'
import { combinedDifficulty } from '../sched/adaptive.ts'
import { advanceStrict } from '../sched/advance.ts'
import { retrievabilityBlock } from '../sched/srs.ts'
import type { DiagnosticItem, RewriteFact, SignalSnapshot } from '../sched/attribution.ts'
import { evaluateSectionSignals, formatSignalDetail, parseRewriteDetail, parseSignalDetail } from '../sched/attribution.ts'
import { calibrationProfileView } from '../sched/calibration.ts'
import type { BandRec } from '../sched/coach.ts'
import { COACH_DUE_HARD_R, COACH_HARD_D, coachFeedback, withinCoachWindow } from '../sched/coach.ts'
...
import { RECEIPT_KIND_LABEL, receiptsUntilNextFull, submitReceipt } from '../practice/receipts.ts'
...
import { execRecsAll } from '../practice/project-exec.ts'
