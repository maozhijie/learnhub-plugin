...
export const GRAPH_VIEW_LINES_HEADING = '### 活跃线（终点接线的各线线头——深度差距与同族堆积是并拢与补弱的读数）'
export const GRAPH_VIEW_LINE_ROW = '- 线头 {{head}}｜深度 {{depth}}{{pres}}'
export const GRAPH_VIEW_LINE_PRES = '← {{names}}'
export const GRAPH_VIEW_ZERO_LINES = '（终点未接线——尚无线头，主线批 set_pre 接线后此处列出各线）'
