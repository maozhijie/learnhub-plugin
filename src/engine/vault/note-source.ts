...
import { isRegistrableCenterRel } from '../learner/output.ts'
...
import { advance, advancePending, alreadyAdvanced } from '../sched/advance.ts'
import { applyRatingBlock, getScheduler, previewDue, retrievabilityBlock } from '../sched/srs.ts'
import { combinedDifficulty } from '../sched/adaptive.ts'
import { invokesTagged } from '../concepts/concepts.ts'
import { withContractLast } from '../infra/prompt-assembly.ts'
import { PASS_SCORE, revealAnswer } from '../infra/grading.ts'
import { findDuplicateStem, existingStemsPromptBlock, bankStemList } from '../content/question-dedup.ts'
import type { LlmComplete } from '../infra/llm.ts'
import type { JolPrediction } from '../sched/jol.ts'
import type { Graph } from '../graph/graph.ts'
import type { BrokenNote } from './notes.ts'
import type { Logger } from '../infra/logger.ts'
import type { QuestionBank, BankDoc, BankQuestion } from '../content/question-bank.ts'
...
import { dayOfTs, nowIsoOf } from '../infra/dates.ts'
...
// ---- 门面原分节：C2 ----
  ...
  async noteSourceGenerate(
    ...
    const rawOut = await llm(withContractLast(tpl,
